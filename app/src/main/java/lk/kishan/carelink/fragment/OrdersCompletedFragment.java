...
import lk.kishan.carelink.databinding.FragmentOrdersCompletedBinding;
...
public class OrdersCompletedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.orderCompletedRecyclerViewOrders.setLayoutManager(new LinearLayoutManager(getContext()));

        loadOCompletedOrders();

        return binding.getRoot();
    }

    private void loadOCompletedOrders() {
        ...
        apiService.getCustomerOrders(customerId).enqueue(new Callback<List<Order>>() {
            ...
            public void onResponse(@NonNull Call<List<Order>> call, @NonNull Response<List<Order>> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    binding.orderCompletedRecyclerViewOrders.setAdapter(orderAdapter);
