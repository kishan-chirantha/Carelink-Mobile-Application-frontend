...
import lk.kishan.carelink.databinding.FragmentOrderOngoingBinding;
...
public class OrderOngoingFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding.orderOngoingRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        apiService.getCustomerOrders(customerId).enqueue(new Callback<List<Order>>() {
            ...
            public void onResponse(@NonNull Call<List<Order>> call, @NonNull Response<List<Order>> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    orderAdapter = new OrderAdapter(ongoingOrders);
                    binding.orderOngoingRecyclerView.setAdapter(orderAdapter);
